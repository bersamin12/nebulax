...
`python scripts/ps3_train.py --task rail`, git `1ecb3e7`, feature version `v2`, seeds [0, 1, 2], 9891 s wall. Every number here is reproducible from `rail_cv.json` in this directory.
...
**Honest headline (nested stratified grouped 5-fold x seeds; complete ladder selected by grouped inner 3-fold, 15 folds): macro F1 0.757 +- 0.123.**
