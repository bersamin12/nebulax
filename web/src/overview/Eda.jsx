  ...
  <section className="ov-sec" style={{ paddingTop: "4px", paddingBottom: "40px", display: "flex", flexDirection: "column", gap: "20px" }}>
    <div style={{ display: "flex", alignItems: "flex-end", gap: "12px" }}>
      ...
      <div className="ov-tabs">
        <button type="button" className={"tab" + (e === 0 ? " on" : "")} onClick={() => setE(0)}><span className="mono" style={{ fontSize: "11px", letterSpacing: ".12em", color: "var(--accent)" }}>01 · DOOR</span><span style={{ fontSize: "14px", fontWeight: "600" }}>110 labelled cycles</span></button>
        <button type="button" className={"tab" + (e === 1 ? " on" : "")} onClick={() => setE(1)}><span className="mono" style={{ fontSize: "11px", letterSpacing: ".12em", color: "var(--accent)" }}>02 · ACV</span><span style={{ fontSize: "14px", fontWeight: "600" }}>6 cases × 8 cars</span></button>
        <button type="button" className={"tab" + (e === 2 ? " on" : "")} onClick={() => setE(2)}><span className="mono" style={{ fontSize: "11px", letterSpacing: ".12em", color: "var(--accent)" }}>03 · RAIL</span><span style={{ fontSize: "14px", fontWeight: "600" }}>272 one-second files</span></button>
        <button type="button" className={"tab" + (e === 3 ? " on" : "")} onClick={() => setE(3)}><span className="mono" style={{ fontSize: "11px", letterSpacing: ".12em", color: "var(--accent)" }}>04 · SHM</span><span style={{ fontSize: "14px", fontWeight: "600" }}>64 stress records</span></button>
      </div>
    ...
    {e === 0 && (<>
      <div className="card ov-card-lg ov-side" style={{ padding: "28px 32px 32px", display: "grid", gridTemplateColumns: "1fr 440px", gap: "36px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>Door · labelled cycles by class</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>n = 110</div></div>
          ...
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginTop: "8px" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>Middle-travel current separates the classes</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>illustrative distribution</div></div>
          <div className="ov-diagram-box ov-chart-box"><svg className="ov-chart" width="640" height="150" viewBox="0 0 640 150" style={{ width: "100%", height: "150px", background: "#f1f3f5", borderRadius: "6px" }} aria-hidden="true">
            ...
            <text x="620" y="16" fontFamily="IBM Plex Mono, monospace" fontSize="9" fill="#5b6673" textAnchor="end">cruise-phase current ratio →</text>
          </svg></div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <div className="ov-g2" style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: "10px" }}>
    ...
    {e === 1 && (<>
      <div className="card ov-card-lg ov-side" style={{ padding: "28px 32px 32px", display: "grid", gridTemplateColumns: "1fr 440px", gap: "36px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>ACV · case × car coverage</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>6 cases × 8 cars · 30 s telemetry each</div></div>
          <div className="ov-g8" style={{ display: "grid", gridTemplateColumns: "80px repeat(8, minmax(0, 1fr))", gap: "6px", fontSize: "12px" }}>
            ...
            <div className="mono" style={{ color: "#5b6673" }}>case 01</div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div>
            <div className="mono" style={{ color: "#5b6673" }}>case 02</div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div>
            <div className="mono" style={{ color: "#5b6673" }}>case 03</div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div>
            <div className="mono" style={{ color: "#5b6673" }}>case 04</div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", border: "1px dashed #a66500", boxSizing: "border-box", borderRadius: "4px" }}></div><div style={{ height: "30px", border: "1px dashed #a66500", boxSizing: "border-box", borderRadius: "4px" }}></div><div style={{ height: "30px", border: "1px dashed #a66500", boxSizing: "border-box", borderRadius: "4px" }}></div><div style={{ height: "30px", border: "1px dashed #a66500", boxSizing: "border-box", borderRadius: "4px" }}></div>
            <div className="mono" style={{ color: "#5b6673" }}>case 05</div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div>
            <div className="mono" style={{ color: "#5b6673" }}>case 06</div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div><div style={{ height: "30px", background: "var(--accent-soft)", borderRadius: "4px" }}></div>
          </div>
          <div style={{ display: "flex", gap: "16px", fontSize: "12px", color: "#5b6673" }}><span style={{ display: "inline-flex", alignItems: "center", gap: "6px" }}><span style={{ width: "12px", height: "12px", background: "var(--accent-soft)", borderRadius: "2px" }}></span>telemetry present</span><span style={{ display: "inline-flex", alignItems: "center", gap: "6px" }}><span style={{ width: "12px", height: "12px", border: "1px dashed #a66500", boxSizing: "border-box", borderRadius: "2px" }}></span>empty car (sorted last)</span></div>
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginTop: "8px" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>The leaking car runs warm against its peers</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>illustrative traces</div></div>
          <div className="ov-diagram-box ov-chart-box"><svg className="ov-chart" width="640" height="140" viewBox="0 0 640 140" style={{ width: "100%", height: "140px", background: "#f1f3f5", borderRadius: "6px" }} aria-hidden="true">
            <line x1="40" y1="110" x2="620" y2="110" stroke="#b8c4cc"></line>
            <rect x="330" y="14" width="270" height="96" fill="rgba(47,98,196,0.08)"></rect>
            <text x="465" y="26" fontFamily="IBM Plex Mono, monospace" fontSize="9" fill="var(--accent)" textAnchor="middle">hot rows (outdoor T ≥ case median)</text>
    ...
    {e === 2 && (<>
      <div className="card ov-card-lg ov-side" style={{ padding: "28px 32px 32px", display: "grid", gridTemplateColumns: "1fr 440px", gap: "36px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>Rail · training files by class</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>n = 272 · 1 s @ 10 kHz · 129 columns</div></div>
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginTop: "8px" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>Speed confounds the label</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>illustrative scatter</div></div>
          <div className="ov-diagram-box ov-chart-box"><svg className="ov-chart" width="640" height="150" viewBox="0 0 640 150" style={{ width: "100%", height: "150px", background: "#f1f3f5", borderRadius: "6px" }} aria-hidden="true">
            <line x1="40" y1="120" x2="620" y2="120" stroke="#b8c4cc"></line>
            ...
            <text x="620" y="16" fontFamily="IBM Plex Mono, monospace" fontSize="9" fill="#5b6673" textAnchor="end">axle-box RMS ↑</text>
    ...
    {e === 3 && (<>
      <div className="card ov-card-lg ov-side" style={{ padding: "28px 32px 32px", display: "grid", gridTemplateColumns: "1fr 440px", gap: "36px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>SHM · label range across the 64 records</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>cumulative damage, 0 to 1</div></div>
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <div style={{ position: "relative", height: "16px", background: "#eceff2", borderRadius: "4px" }}><div style={{ position: "absolute", left: "2.9%", width: "89.9%", height: "100%", background: "var(--accent)", borderRadius: "4px" }}></div></div>
          ...
          <div className="ov-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginTop: "8px" }}><div style={{ fontSize: "18px", fontWeight: "600" }}>Rainflow with m = 5 reproduces the labels</div><div className="mono" style={{ fontSize: "11px", color: "#5b6673" }}>in-sample diagnostic, MAPE 0.0254</div></div>
          <div className="ov-diagram-box ov-chart-box"><svg className="ov-chart" width="640" height="160" viewBox="0 0 640 160" style={{ width: "100%", height: "160px", background: "#f1f3f5", borderRadius: "6px" }} aria-hidden="true">
